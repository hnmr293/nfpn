...
class TestToFp12(unittest.TestCase):
    ...
    def test_normal_fp16_subnormal_fp12(self):
        xs = [
            # exp  value               fp16                   fp12 (expected)
            (-1,   0.5,                0b0_01110_0000000000,  0b0_000_11100000),
            (-2,   0.25,               0b0_01101_0000000000,  0b0_000_11000000),
            (-3,   0.125,              0b0_01100_0000000000,  0b0_000_10100000),
            (-4,   0.0625,             0b0_01011_0000000000,  0b0_000_10000000),
            (-1,  -0.5,                0b1_01110_0000000000,  0b1_000_11100000),
            (-2,  -0.25,               0b1_01101_0000000000,  0b1_000_11000000),
            (-3,  -0.125,              0b1_01100_0000000000,  0b1_000_10100000),
            (-4,  -0.0625,             0b1_01011_0000000000,  0b1_000_10000000),
            (-12,  0.000244140625,     0b0_00011_0000000000,  0b0_000_01100000),
            (-13,  0.0001220703125,    0b0_00010_0000000000,  0b0_000_01000000),
            (-14,  6.103515625e-05,    0b0_00001_0000000000,  0b0_000_00100000),
            (-12, -0.000244140625,     0b1_00011_0000000000,  0b1_000_01100000),
            (-13, -0.0001220703125,    0b1_00010_0000000000,  0b1_000_01000000),
            (-14, -6.103515625e-05,    0b1_00001_0000000000,  0b1_000_00100000),
        ]
    ...
    def test_subnormal_fp16_subnormal_fp12(self):
        xs = [
            # exp  value                   fp16                  fp12 (expected)
            (-15, 3.0517578125e-05,        0b0_00000_1000000000, 0b0_000_000_10000),
            (-16, 1.52587890625e-05,       0b0_00000_0100000000, 0b0_000_000_01000),
            (-17, 7.62939453125e-06,       0b0_00000_0010000000, 0b0_000_000_00100),
            (-18, 3.814697265625e-06,      0b0_00000_0001000000, 0b0_000_000_00010),
            (-19, 1.9073486328125e-06,     0b0_00000_0000100000, 0b0_000_000_00001),
            (-20, 9.5367431640625e-07,     0b0_00000_0000010000, 0b0_000_000_00000),
            (-21, 4.76837158203125e-07,    0b0_00000_0000001000, 0b0_000_000_00000),
            (-22, 2.384185791015625e-07,   0b0_00000_0000000100, 0b0_000_000_00000),
            (-23, 1.1920928955078125e-07,  0b0_00000_0000000010, 0b0_000_000_00000),
            (-24, 5.960464477539063e-08,   0b0_00000_0000000001, 0b0_000_000_00000),
            (-15, -3.0517578125e-05,       0b1_00000_1000000000, 0b1_000_000_10000),
            (-16, -1.52587890625e-05,      0b1_00000_0100000000, 0b1_000_000_01000),
            (-17, -7.62939453125e-06,      0b1_00000_0010000000, 0b1_000_000_00100),
            (-18, -3.814697265625e-06,     0b1_00000_0001000000, 0b1_000_000_00010),
            (-19, -1.9073486328125e-06,    0b1_00000_0000100000, 0b1_000_000_00001),
            (-20, -9.5367431640625e-07,    0b1_00000_0000010000, 0b1_000_000_00000),
            (-21, -4.76837158203125e-07,   0b1_00000_0000001000, 0b1_000_000_00000),
            (-22, -2.384185791015625e-07,  0b1_00000_0000000100, 0b1_000_000_00000),
            (-23, -1.1920928955078125e-07, 0b1_00000_0000000010, 0b1_000_000_00000),
            (-24, -5.960464477539063e-08,  0b1_00000_0000000001, 0b1_000_000_00000),
        ]
    ...
    def test_subnormal_fp12_combine(self):
        ...
        for exp, x0, fp16_e, fp12_e in xs:
            for x1, fp16_f, fp12_f in fs:
                ...
                e_expected = fp12_e >> 8
                f_expected = (fp12_e & 0b1110_0000) | (fp12_f >> 3)
...
class TestToFp16(unittest.TestCase):
    ...
    def test_normal_fp12(self):
        ...
        for exp, fp12_e, fp16_e in es:
            ...
            self.assertEqual(x >> 10, fp16_e, [exp, fp12_e, ee, ff, x, fp16_e])
        ...
        for exp, fp12_e, fp16_e in es:
            for fp12_f in range(0x100):
                ...
                self.assertEqual(x & 0b11_1111_1111, fp16_f)
